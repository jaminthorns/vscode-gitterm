...
functionality that is provided is read-only, nothing that will modify your Git
repository. I favor using the Git CLI, and VS Code has plenty of that
functionality built out already.

Where VS Code's Git features falls a bit short is in the "history investigation"
